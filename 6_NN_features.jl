...
train = CSV.read("E:/SFU_MA/SFUComputationalEconomics2024/final/train_set_features.csv", DataFrame)
test = CSV.read("E:/SFU_MA/SFUComputationalEconomics2024/final/test_set_features.csv", DataFrame)
...
train_selected = select(train, :location_rehovot, :gender_female, :age,
                                ...
                                :payoff, :apay, :bpay,
                                :rt, :feedback,  :order, :button_r, 
                                :risk_aversion_index, :b_same_as_prev,  :b)
...
competition = CSV.read("E:/SFU_MA/SFUComputationalEconomics2024/final/clean_competition_features.csv", DataFrame)
...
CSV.write("E:/SFU_MA/SFUComputationalEconomics2024/final/confusion_matrix_train_features_dfnn.csv", DataFrame(confusion_matrix_train, :auto))

# Export the confusion matrix of the model on the competition data

CSV.write("E:/SFU_MA/SFUComputationalEconomics2024/final/confusion_matrix_competition_features_dfnn.csv", DataFrame(confusion_matrix_competition, :auto))
...
CSV.write("E:/SFU_MA/SFUComputationalEconomics2024/final/accuracies_features_dfnn.csv", accuracies_df)
...
CSV.write("E:/SFU_MA/SFUComputationalEconomics2024/final/losses_features_dfnn.csv", losses_df)